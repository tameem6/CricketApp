    ...
    render()
    {
        return(
                <div className="menubar">
                    ...
                    <button className="btn btn-danger nav-link dropdown-toggle mr-5" id="navbarDropdown" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">{this.props.user}</button>
